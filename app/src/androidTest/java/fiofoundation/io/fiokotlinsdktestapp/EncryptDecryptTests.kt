...
class EncryptDecryptTests
{
    ...
    fun testEncryptDecryptRequestFunds()
    {
        ...
        try
        {
            val fundsRequestContent = FundsRequestContent(payeeTokenPublicAddress = payeeTokenPublicAddress, amount=amount.toString(), chainCode = chainCode, tokenCode = tokenCode, memo=memo, hash=hash, offlineUrl = offlineUrl)
    ...
    fun testEncryptDecryptRequestFundsTypeScriptSDK()
    {
        ...
        try
        {
            ...
            val encryptedRequestContent = "UKPHFo0xs3GwGAXMc44QqkDtj7dcbGHjU3cJmN1qiYWADvzyd9pen2WwKn0VZtk0ZTGFXpap7Id8nZxlCMK7TjkabO85XNbhausE4ZZzx3hm25bqV2GDRHpRomsRDGAzLbFEumsm+4UNBtnOqUK3Kuo91vKjlLIV3NoF83qOSbhL8QDqV2N/yJxSu4PsiDeqhhSypZx8McaubVoUueioWA=="
    ...
    fun testEncryptDecryptRequestFundsiOSSDK()
    {
        ...
        try
        {
            ...
            val encryptedRequestContent = "iNz623p8SjbFG3rNbxLeVzQhs7n4aB8UGHvkF08HhBXD3X9g6bVFJl93j/OqYdkiycxShF64uc9OHFc/qbOeeS8+WVL2YRpd9JaRqdTUE9XKFPZ6lETQ7MTbGT+qppMoJ0tWCP6mWL4M9V1xu6lE3lJkuRS4kXnwtOUJOcBDG7ddFyHaV1LnLY/jnOJHJhm8"
            ...
            assertTrue(
                "Couldn't decrypt",
                decryptedContent?.payeeTokenPublicAddress == payeeTokenPublicAddress
            )
        }
        catch (e: FIOError)
        {
    ...
    fun testEncryptDecryptRecordObtDataTypeScriptSDK()
    {
        ...
        try
        {
            ...
            val encryptedRequestContent = ""
    ...
    fun testEncryptDecryptRecordObtDataiOSSDK()
    {
        ...
        try
        {
            ...
            val encryptedRequestContent = ""
