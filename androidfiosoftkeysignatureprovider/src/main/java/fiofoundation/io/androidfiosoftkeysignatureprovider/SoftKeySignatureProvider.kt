...
import fiofoundation.io.androidfiosoftkeysignatureprovider.errors.SoftKeySignatureErrorConstants
...
class SoftKeySignatureProvider: ISignatureProvider
{
    ...
    private val DEFAULT_WHETHER_USING_K1_LEGACY_FORMAT = USING_K1_NON_LEGACY_FORMAT
