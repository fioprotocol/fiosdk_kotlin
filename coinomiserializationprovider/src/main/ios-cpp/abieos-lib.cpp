...
extern "C"
{
    ...
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_stringFromAbiEos(JNIEnv *env, jobject /* this */) {
        std::string hello = "Hello from abieos-lib!!";
        return env->NewStringUTF(hello.c_str());
    }

    JNIEXPORT jobject JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_create(JNIEnv *env, jobject /* this */) {
        abieos_context* context = abieos_create();
        return env->NewDirectByteBuffer((void *)context, sizeof(context));
    }

    JNIEXPORT void JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_destroy(JNIEnv *env, jobject /* this */, jobject context_direct_byte_buffer) {
    ...
    JNIEXPORT jstring JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_getError(JNIEnv *env, jobject /* this */, jobject context_direct_byte_buffer) {
        abieos_context* context = getContext(env, context_direct_byte_buffer);
        return env->NewStringUTF(abieos_get_error(context));
    }

    JNIEXPORT jint JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_getBinSize(JNIEnv *env, jobject /* this */,
    ...
    JNIEXPORT jobject JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_getBinData(JNIEnv *env, jobject /* this */,
            jobject context_direct_byte_buffer) {
        abieos_context* context = getContext(env, context_direct_byte_buffer);
    ...
    JNIEXPORT jstring JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_getBinHex(JNIEnv *env, jobject /* this */, jobject context_direct_byte_buffer) {
        abieos_context* context = getContext(env, context_direct_byte_buffer);
    ...
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_stringToName(JNIEnv *env, jobject /* this */,
            jobject context_direct_byte_buffer,
            jstring str) {
        abieos_context* context = getContext(env, context_direct_byte_buffer);
        jboolean isCopy;
    ...
    JNIEXPORT jstring JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_nameToString(JNIEnv *env, jobject /* this */,
            jobject context_direct_byte_buffer,
            jlong name) {
        abieos_context* context = getContext(env, context_direct_byte_buffer);
    ...
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_setAbi(JNIEnv *env, jobject /* this */,
            jobject context_direct_byte_buffer,
            jlong contract,
            jstring abi) {
        abieos_context* context = getContext(env, context_direct_byte_buffer);
    ...
    JNIEXPORT jboolean JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_jsonToBin(JNIEnv *env, jobject /* this */,
            jobject context_direct_byte_buffer,
            jlong contract,
            jstring type,
            jstring json,
    ...
    JNIEXPORT jstring JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_hexToJson(JNIEnv *env, jobject /* this */,
              jobject context_direct_byte_buffer,
              jlong contract,
              jstring type,
              jstring hex) {
    ...
    JNIEXPORT jstring JNICALL
    Java_fiofoundation_io_coinomiserializationprovider_AbiFIOSerializationProvider_getTypeForAction(JNIEnv *env, jobject /* this */,
              jobject context_direct_byte_buffer,
              jlong contract,
              jlong action) {
        abieos_context* context = getContext(env, context_direct_byte_buffer);
