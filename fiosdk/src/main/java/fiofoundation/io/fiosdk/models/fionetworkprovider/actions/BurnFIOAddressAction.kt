...
class BurnFIOAddressAction(fioAddress: String, maxFee: BigInteger, technologyPartnerId: String,
    ...
    IAction
{
    ...
    class BurnFIOAddressRequestData(@field:SerializedName("fio_address") var fioAddress:String,
