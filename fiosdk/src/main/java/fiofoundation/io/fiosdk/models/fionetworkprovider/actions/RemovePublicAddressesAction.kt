...
class RemovePublicAddressesAction(fioAddress: String,
    ...
    IAction
{
    ...
    class RemoveAddressRequestData(@field:SerializedName("fio_address") var fioAddress:String,
